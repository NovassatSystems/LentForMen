...
[assembly: ExportEffect(typeof(Autem.iOS.Effects.SafeAreaInsetEffect), "SafeAreaInsetEffect")]
namespace Autem.iOS.Effects
{
    public class SafeAreaInsetEffect : PlatformEffect
    {
        ...
        private static void ApplyInsets(PaddingElement paddingElement, Thickness defaultPadding)
        {
            ...
            var insetFlags = Core.SafeAreaInsetEffect.GetInsets(paddingElement.Element);
